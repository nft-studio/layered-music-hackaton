...
async function main() {
  ...
  try {
    ...
    const resultOwner = await nftContract.methods
      .addMinter(OWNER_ADDRESS)
      .send({ from: OWNER_ADDRESS });
    console.log(resultOwner)
    const resultSecondary = await nftContract.methods
      .addMinter("0x9e910D267Db6Dd064b2214Ce0878f83fFc7DE40a")
      .send({ from: OWNER_ADDRESS });
