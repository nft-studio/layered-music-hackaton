...
if (isset($_POST['image']) && isset($_POST['sequence'])) {
    ...
    $descriptionObject->description = "Sequence " . $_POST['sequence'] . " is a generative audio created with LayeredMusic, a project by NFT-Studio. Original audio tracks created by 0xJitzu";
    $descriptionObject->image = "https://layeredmusic.nftstud.io/api/images/" . $_POST['sequence'] . ".png";
    $descriptionObject->external_url = "https://layeredmusic.nftstud.io/";
